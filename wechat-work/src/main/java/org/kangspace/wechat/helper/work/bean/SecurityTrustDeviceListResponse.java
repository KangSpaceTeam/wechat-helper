...
/**
 * 安全管理-设备管理-获取设备信息 响应参数<br>
 * 注意，当获取未确认为可信企业设备的记录时，即获取status为2、4、6时，mac地址，序列号，主板UUID等将会返回脱敏数据。<br>
 *
...
@Setter
@Getter
public class SecurityTrustDeviceListResponse extends WeComResponseEntity {
    ...
    public String toString() {
        return super.isError() ? super.toString() : (
                "SecurityTrustDeviceListResponse{" +
