...
/**
 * 应用管理-获取应用在工作台展示的模版-关键数据型 请求对象<br>
 * <pre>
 * </pre>
 *
...
public class AgentSetWorkbenchKeyDataTemplateRequest extends AgentSetWorkbenchTemplateRequest {
    @JsonIgnore
    public final String TYPE = "keydata";
    /**
