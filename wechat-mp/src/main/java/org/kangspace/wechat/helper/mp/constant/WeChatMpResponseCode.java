 ...
 * <pre>
 * 微信公众号全局返回码 枚举。
 * 全局返回码文档: <a href="https://developers.weixin.qq.com/doc/offiaccount/Getting_Started/Global_Return_Code.html">https://developers.weixin.qq.com/doc/offiaccount/Getting_Started/Global_Return_Code.html</a>
 * AccessToken返回码文档: <a href="https://developers.weixin.qq.com/doc/offiaccount/Basic_Information/Get_access_token.html">https://developers.weixin.qq.com/doc/offiaccount/Basic_Information/Get_access_token.html</a>
 * </pre>
 *
 * @author kango2gler@gmail.com
 * @since 2022/11/24
 */
public enum WeChatMpResponseCode {
    /**
     * 系统繁忙，此时请开发者稍候再试
     */
     ...
     */
    CODE_10003(10003, "redirect_uri域名与后台配置不一致"),
    /**
     * 此公众号被封禁
     */
    CODE_10004(10004, "此公众号被封禁"),
    /**
     * 此公众号并没有这些 scope 的权限
     */
    CODE_10005(10005, "此公众号并没有这些 scope 的权限"),
    /**
     * 必须关注此测试号
     */
    CODE_10006(10006, "必须关注此测试号"),
    /**
     * 操作太频繁了，请稍后重试
     */
    CODE_10009(10009, "操作太频繁了，请稍后重试"),
    /**
     * scope不能为空
     */
    CODE_10010(10010, "scope不能为空"),
    /**
     * redirect_uri不能为空
     */
    CODE_10011(10011, "redirect_uri不能为空"),
    /**
     * appid不能为空
     */
    CODE_10012(10012, "appid不能为空"),
    /**
     * state不能为空
     */
    CODE_10013(10013, "state不能为空"),
    /**
     * 公众号未授权第三方平台，请检查授权状态
     */
    CODE_10015(10015, "公众号未授权第三方平台，请检查授权状态"),
    /**
     * 不支持微信开放平台的Appid，请使用公众号Appid
     */
    CODE_10016(10016, "不支持微信开放平台的Appid，请使用公众号Appid"),
    /**
     * 系统错误
     */
     ...
     * 订阅模板 id 为空不正确
     */
    CODE_40035(40035, "订阅模板 id 为空不正确"),
    /**
     *
     */
    CODE_40037(40037, "不合法的参数"),
    /**
     * 不合法的请求格式
     */
    ...
    /**
     * 调用接口的 IP 地址不在白名单中，请在接口 IP 白名单中进行设置。
     */
    CODE_40164(40164, "调用接口的 IP 地址不在白名单中，请在接口 IP 白名单中进行设置。"),
    /**
     * 标题为空
     */
     ...
     */
    CODE_45056(45056, "创建的标签数过多，请注意不能超过100个"),
    /**
     * 该标签下粉丝数超过10w，不允许直接删除
     */
    CODE_45057(45057, "该标签下粉丝数超过10w，不允许直接删除"),
    /**
     * 不能修改0/1/2这三个系统默认保留的标签
     */
    CODE_45058(45058, "不能修改0/1/2这三个系统默认保留的标签"),
    /**
     * 有粉丝身上的标签数已经超过限制，即超过20个
     */
    CODE_45059(45059, "有粉丝身上的标签数已经超过限制，即超过20个"),
    /**
     * 标签名非法，请注意不能和其他标签重名
     */
    CODE_45157(45157, "标签名非法，请注意不能和其他标签重名"),
    /**
     * 标签名长度超过30个字节
     */
    CODE_45158(45158, "标签名长度超过30个字节"),
    /**
     * 非法的tag_id
     */
    ...
    /**
     * 自动保存的草稿无法预览/发送，请先手动保存草稿
     */
    CODE_48021(48021, "自动保存的草稿无法预览/发送，请先手动保存草稿"),
    /**
     * 传入的openid不属于此AppID
     */
    CODE_49003(49003, "传入的openid不属于此AppID"),
    /**
     * 用户未授权该 api
     */
    ...
    /**
     * 当前调用接口使用的 token 与api所属账号不符，详情可看注意事项的说明
     */
    CODE_76022(76022, "当前调用接口使用的 token 与api所属账号不符，详情可看注意事项的说明"),
    /**
     * 无效的签名
     */
    CODE_87009(87009, "无效的签名"),
    /**
     * 此 IP 调用需要管理员确认,请联系管理员
     */
    CODE_89503(89503, "此 IP 调用需要管理员确认,请联系管理员"),
    /**
     * 此 IP 正在等待管理员确认,请联系管理员
     */
    CODE_89501(89501, "此 IP 正在等待管理员确认,请联系管理员"),
    /**
     * 24小时内该 IP 被管理员拒绝调用两次，24小时内不可再使用该 IP 调用
     */
    CODE_89506(89506, "24小时内该 IP 被管理员拒绝调用两次，24小时内不可再使用该 IP 调用"),
    /**
     * 1小时内该 IP 被管理员拒绝调用一次，1小时内不可再使用该 IP 调用
     */
    CODE_89507(89507, "1小时内该 IP 被管理员拒绝调用一次，1小时内不可再使用该 IP 调用"),
    /**
     * POST 数据参数不合法
     */
    ...
    WeChatMpResponseCode(Integer code, String message) {
        this.code = code;
     ...
     *
     * @param code 响应码
     * @return {@link WeChatMpResponseCode}
     */
